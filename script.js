document.addEventListener('DOMContentLoaded', () => {
    ...
    const questions = [
        {
    question: "P(3, 4) বিন্দু থেকে x-অক্ষের দূরত্ব কত?",
    options: ["3", "4", "5", "7"],
    correct: 1
  },
  {
    question: "(-2, 5) এবং (4, -3) বিন্দু দুইটির মধ্যে দূরত্ব কত?",
    options: ["10", "√100", "√116", "12"],
    correct: 2
  },
  {
    question: "সরলরেখা y = 2x + 3 এর ঢাল কত?",
    options: ["2", "3", "-2", "-3"],
    correct: 0
  },
  {
    question: "(1, 2) এবং (5, 10) বিন্দু দুটি যোগকারী রেখার ঢাল কত?",
    options: ["2", "1/2", "4", "8"],
    correct: 0
  },
  {
    question: "(x1, y1) ও (x2, y2) বিন্দুর মধ্যবিন্দুর স্থানাঙ্ক কত?",
    options: ["(x1+x2, y1+y2)", "((x1+x2)/2, (y1+y2)/2)", "((x1-x2)/2, (y1-y2)/2)", "(x1-x2, y1-y2)"],
    correct: 1
  },
  {
    question: "কেন্দ্র (0,0) ও ব্যাসার্ধ 5 হলে বৃত্তের সমীকরণ কী হবে?",
    options: ["x² + y² = 25", "x² + y² = 5", "x² + y² = 10", "x² + y² = 50"],
    correct: 0
  },
  {
    question: "(1, 1) বিন্দু সরলরেখা 2x - 3y + 1 = 0 এর ওপর অবস্থিত কিনা?",
    options: ["হ্যাঁ", "না", "কখনো হ্যাঁ, কখনো না", "নির্ণয় করা যায় না"],
    correct: 1
  },
  {
    question: "(2, –1) থেকে (–4, 3) পর্যন্ত সরলরেখা খণ্ডকে 1:2 অনুপাতে বিভক্তকারী বিন্দুর স্থানাঙ্ক কী?",
    options: ["(-2, 1)", "(0, 1)", "(-1, 1)", "(-2, 2)"],
    correct: 2
  },
  
  {
    question: "সমীকরণ x² + y² – 4x – 6y + 9 = 0 দ্বারা কোন বৃত্ত নির্দেশ করে?",
    options: ["কেন্দ্র (2,3), ব্যাসার্ধ 2", "কেন্দ্র (2,3), ব্যাসার্ধ 4", "কেন্দ্র (2,3), ব্যাসার্ধ 1", "কেন্দ্র (3,2), ব্যাসার্ধ 2"],
    correct: 2
  },
  {
    question: "কেন্দ্র (a, b) ও ব্যাসার্ধ r হলে বৃত্তের সমীকরণ কী?",
    options: ["x² + y² = r²", "(x+a)² + (y+b)² = r²", "(x-a)² + (y-b)² = r²", "(x-a)² + (y+b)² = r²"],
    correct: 2
  },
  {
    question: "দুইটি সরলরেখা সমান্তরাল হলে তাদের ঢাল কেমন হবে?",
    options: ["সমান", "বিপরীত", "গুণফল –1", "নির্ণয়যোগ্য নয়"],
    correct: 0
  },
  {
    question: "দুটি সরলরেখা পরস্পর লম্ব হলে তাদের ঢালের গুণফল কত হয়?",
    options: ["1", "-1", "0", "অসীম"],
    correct: 1
  },
  {
    question: "বিন্দু (0, 3) থেকে x-অক্ষের দূরত্ব কত?",
    options: ["3", "0", "-3", "6"],
    correct: 0
  },
